...
varying float vTime;
varying vec3 newTransformedPosition;
...
//   csm_Position = newPosition;
  ...
  csm_Position = distortedPosition;
  vec3 newNormal = normalize(cross(distorted1 - distortedPosition, distorted2 - distortedPosition));
  csm_Normal = newNormal;
}